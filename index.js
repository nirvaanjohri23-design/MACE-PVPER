...
bot.once('spawn', () => { setTimeout(() => { bot.equip('Shield', 'off-hand'); }, 1000); setInterval(() => { const player = bot.nearestEntity(e => e.type === 'player'); if (player) bot.lookAt(player.position.offset(0, player.position.y - bot.entity.position.y + 1.62, 0)); }, 1000); });
